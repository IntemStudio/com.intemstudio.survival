...
const TABLE: Dictionary = {
	LOCALE_KO: {
		...
		"inventory.hint": "%s: 인벤 · %s: 전투 세트 전환 · 가방 우클릭/더블클릭: 장착 · 장비 우클릭: 해제 · 드래그: 이동 · 비활성 무기/보조 좌클릭: 세트 편집",
	...
	LOCALE_EN: {
		...
		"inventory.hint": "%s: inventory · %s: swap combat set · Bag RMB/double-click: equip · Gear RMB: unequip · Drag: move · Click inactive weapon/off: edit set",
