...
const TABLE: Dictionary = {
	LOCALE_KO: {
		...
		"settings.chase_skill_range": "추격 기술 거리 표시",
		"settings.chase_stop_range": "추격 최소 거리 표시",
		...
		"gear_select.arena_wave_clear": "웨이브 클리어! 장비 선택",
	...
	LOCALE_EN: {
		...
		"settings.chase_skill_range": "Show chase skill range",
		"settings.chase_stop_range": "Show chase minimum distance",
		...
		"gear_select.arena_wave_clear": "Wave Clear! Choose Gear",
