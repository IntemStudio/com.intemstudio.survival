...
const TABLE: Dictionary = {
	LOCALE_KO: {
		...
		"weapon_select.level_up": "레벨 업! 무기 획득",
		"weapon_select.arena_wave_clear": "웨이브 클리어! 무기 획득",
		...
		"inventory.hint": "%s: 인벤 · %s: 전투 세트 전환 · 가방 우클릭/더블클릭: 장착 · 장비 우클릭: 해제 · 왼쪽 Shift+좌클릭: 버리기 · 드래그: 이동 · 비활성 무기/보조 좌클릭: 세트 편집",
	...
	LOCALE_EN: {
		...
		"weapon_select.level_up": "Level Up! Acquire a Weapon",
		"weapon_select.arena_wave_clear": "Wave Clear! Acquire a Weapon",
		...
		"inventory.hint": "%s: inventory · %s: swap combat set · Bag RMB/double-click: equip · Gear RMB: unequip · Left Shift+LMB: drop · Drag: move · Click inactive weapon/off: edit set",
