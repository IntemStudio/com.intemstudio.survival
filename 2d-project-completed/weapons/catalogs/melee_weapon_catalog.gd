...
static func _build_cache() -> void:
	var entries: Array[Dictionary] = [
		...
		{"id": "rapier", "en": "Rapier", "ko": "레이피어", "subtype": "One Handed Sword", "hand": 1, "min": 115, "max": 240, "aps": 2.0, "range": "Medium", "effect": "On wave start, grants En Garde: +20% attack speed for 8 seconds.", "movement": "Return"},
