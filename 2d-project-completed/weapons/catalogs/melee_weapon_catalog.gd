...
static func _build_cache() -> void:
	var entries: Array[Dictionary] = [
		{"id": "dagger", "en": "Dagger", "ko": "단검", "subtype": "Dagger", "hand": 1, "min": 90, "max": 185, "aps": 2.0, "range": "Short", "effect": "Primary attack deals thrusting damage."},
		{"id": "spiky_flail", "en": "Spiky Flail", "ko": "가시 철퇴", "subtype": "Flail", "hand": 1, "min": 55, "max": 100, "aps": 1.0, "range": "Medium", "effect": "Primary attack spins a flail that deals striking damage."},
		{"id": "katana", "en": "Katana", "ko": "카타나", "subtype": "Two Handed Sword", "hand": 2, "min": 55, "max": 125, "aps": 2.5, "range": "Far", "effect": "Primary attack deals slashing damage."},
		...
		{"id": "poleaxe", "en": "Poleaxe", "ko": "폴액스", "subtype": "Polearm", "hand": 2, "min": 95, "max": 200, "aps": 2.0, "range": "Far", "effect": "Primary attack deals slashing damage."},
		{"id": "circus_knives", "en": "Circus Knives", "ko": "서커스 나이프", "subtype": "Dagger", "hand": 2, "min": 110, "max": 205, "aps": 2.0, "range": "Very Short", "effect": "Primary attack deals thrusting damage."},
		...
		{"id": "rusty_fans", "en": "Rusty Fans", "ko": "녹슨 부채", "subtype": "Fan", "hand": 2, "min": 55, "max": 105, "aps": 3.0, "range": "Medium", "effect": "Primary attacks deal slashing damage and can hit multiple times.", "hits": 3},
