...
const TestArenaStatusEffectController = preload("res://game/test_arena_status_effect_controller.gd")
const TestArenaWeaponPanelController = preload("res://game/test_arena_weapon_panel_controller.gd")
const TestArenaGearPanelController = preload("res://game/test_arena_gear_panel_controller.gd")
const TestArenaMobPanelController = preload("res://game/test_arena_mob_panel_controller.gd")
...
var _status_effect_controller := TestArenaStatusEffectController.new()
var _weapon_panel_controller := TestArenaWeaponPanelController.new()
var _gear_panel_controller := TestArenaGearPanelController.new()
var _mob_panel_controller := TestArenaMobPanelController.new()
