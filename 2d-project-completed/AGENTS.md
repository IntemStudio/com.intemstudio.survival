...
- F6: `test_arena.tscn` (현재 씬으로 실행 — F5와 다름)
...
변경 범위에 맞게 Godot에서 확인합니다. 주차별 목표는 [`Docs/Plan/Weekly/`](Docs/Plan/Weekly/)의 `QA / Verification`을 따릅니다.

- 파싱 에러 없이 프로젝트 열기
- **F6:** `test_arena.tscn` 현재 씬 — 몹 Spawn, 무기 Equip, 리스폰
